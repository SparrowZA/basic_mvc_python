...
class ViewInterface(ABC):
    @abstractclassmethod
    def show_bullet_point_list():
        pass
    @abstractclassmethod
    def show_number_point_list():
        pass
    @abstractclassmethod
    def show_item():
        pass
    @abstractclassmethod
    def display_missing_item_error():
        pass
    @abstractclassmethod
    def display_item_already_stored_error():
        pass
    @abstractclassmethod
    def display_item_not_yet_stored_error():
        pass
    @abstractclassmethod
    def display_change_item_type():
        pass
    @abstractclassmethod
    def display_item_updated():
        pass
    @abstractclassmethod
    def display_item_deletion():
        pass
